...
export const PercentComplete: FC<PercentCompleteProps> = (props: PercentCompleteProps) => {
  ...
  return (
    <Box marginY={5} {...rest}>
      <Progress hasStripe isAnimated value={progressFn(numFields, numErrors)} {...progressProps} />
    </Box>
  )
}
