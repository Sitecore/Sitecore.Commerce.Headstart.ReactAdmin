...
const Header = () => {
  return (
    <Container as="header" backgroundColor={useColorModeValue("white", "gray.600")} maxW="full" position="sticky" top="0px" zIndex="10" borderBottom={`.5px solid ${schraTheme.colors.blackAlpha[300]}`}>
